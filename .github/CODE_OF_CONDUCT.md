...
> 本文件为 [Contributor Covenant 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html) 官方简体中文译本；如中英文本有出入，以英文原文为准。
...
社区领导有权力和责任删除、编辑或拒绝与本行为准则不相符的评论（comment）、提交（commits）、代码、维基（wiki）编辑、议题（issues）或其他贡献，并在适当时机知悉措施的理由。
...
辱骂、骚扰或其他不可接受的行为可通过 jukanntenn@outlook.com 向负责监督的社区领袖报告，或使用所在平台自带的举报 / 标记功能。所有投诉都将得到及时和公平的审查和调查。
